...
Checkout my [swift-mcp-toolkit example](https://github.com/ajevans99/swift-mcp-toolkit/tree/main/Example) which uses `swift-json-schema` to create type-safe [OpenAI API function tool calls](https://platform.openai.com/docs/guides/function-calling).
