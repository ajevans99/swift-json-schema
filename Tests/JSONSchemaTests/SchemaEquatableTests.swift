...
struct SchemaEquatableTests {
  ...
  func equal() {
    ...
    #expect(Schema.array(.annotations(description: "Description")) == Schema.array(.annotations(description: "Description")))
    #expect(
      Schema.array(
  ...
  func notEquals() {
    ...
    #expect(Schema.array(.annotations(description: "Description1")) != Schema.array(.annotations(description: "Description2")))
    #expect(
      Schema.array(
        .annotations(description: "Description"),
        .options(uniqueItems: true)
  ...
  @Test
  func inconguentOptions() {
    #expect(
      Schema(type: .object, options: nil, annotations: .annotations(), enumValues: nil)
      !=
      Schema(type: .object, options: ObjectSchemaOptions().eraseToAnySchemaOptions(), annotations: .annotations(), enumValues: nil)
    )
  }
}
