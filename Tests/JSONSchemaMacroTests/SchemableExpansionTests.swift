...
struct SchemableExpansionTests {
  ...
  @Test func dictionaryWithCustomType() {
    assertMacroExpansion(
      """
      @Schemable
      struct Child {
      ...
      expandedSource: """
        struct Child {
          ...
          static var schema: some JSONSchemaComponent<Child> {
            JSONSchema(Child.init) {
              JSONObject {
        ...
        extension Child: Schemable {
        }
        struct Parent {
          let children: [String: Child]

          static var schema: some JSONSchemaComponent<Parent> {
            JSONSchema(Parent.init) {
              JSONObject {
