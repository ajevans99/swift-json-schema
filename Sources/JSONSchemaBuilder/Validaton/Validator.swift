...
public protocol Validator: Sendable {
  ...
  func validate(object: [String: JSONValue], against options: ObjectSchemaOptions) -> Validation<[String: JSONValue]>
  func validate(array: [JSONValue], against options: ArraySchemaOptions) -> Validation<[JSONValue]>
}
